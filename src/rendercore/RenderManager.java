...
public class RenderManager extends Object {
	...
	public void getrenderedOutput(ViewPort requestSender){
		...
		System.err.println("RenderManager Frame["+String.valueOf(frameNo)+"] : Rendering Started");
		System.err.flush();
		...
		System.err.println("RenderManager Frame["+String.valueOf(frameNo++)+"] : Render Complete in ["+String.valueOf(time)+"] ms");
		System.err.flush();
	}
}
